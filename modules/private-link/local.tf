locals {
  ...
  lightlytics_dns = var.enable_privatelink ? [for entry in aws_vpc_endpoint.streamsec[0].dns_entry : entry.dns_name if can(regex("lightlytics\\.com$", entry.dns_name))][0] : null
}